...
public:
    ...
    QLabel *label_9;
    QSpinBox *scotomaAutoViewDist;
    QLabel *label_10;
    QSpinBox *scotomaAutoSizeDegrees;
    QPushButton *scotomaAutoSize;
    ...
    void setupUi(QMainWindow *EyeTrackingSuiteClass)
    {
        ...
        groupBox_2->setGeometry(QRect(20, 20, 211, 251));
        ...
        groupBox_8->setGeometry(QRect(10, 100, 191, 141));
        label_9 = new QLabel(groupBox_8);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(20, 30, 111, 21));
        scotomaAutoViewDist = new QSpinBox(groupBox_8);
        scotomaAutoViewDist->setObjectName(QStringLiteral("scotomaAutoViewDist"));
        scotomaAutoViewDist->setGeometry(QRect(130, 30, 42, 22));
        scotomaAutoViewDist->setMinimum(1);
        scotomaAutoViewDist->setMaximum(60);
        scotomaAutoViewDist->setValue(24);
        label_10 = new QLabel(groupBox_8);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(20, 60, 111, 21));
        scotomaAutoSizeDegrees = new QSpinBox(groupBox_8);
        scotomaAutoSizeDegrees->setObjectName(QStringLiteral("scotomaAutoSizeDegrees"));
        scotomaAutoSizeDegrees->setGeometry(QRect(130, 60, 42, 22));
        scotomaAutoSizeDegrees->setMinimum(1);
        scotomaAutoSizeDegrees->setMaximum(20);
        scotomaAutoSizeDegrees->setValue(10);
        scotomaAutoSize = new QPushButton(groupBox_8);
        scotomaAutoSize->setObjectName(QStringLiteral("scotomaAutoSize"));
        scotomaAutoSize->setGeometry(QRect(20, 100, 151, 31));
        groupBox_3 = new QGroupBox(tab_4);
        groupBox_3->setObjectName(QStringLiteral("groupBox_3"));
        groupBox_3->setGeometry(QRect(20, 290, 211, 161));
    ...
    void retranslateUi(QMainWindow *EyeTrackingSuiteClass)
    {
        ...
        groupBox_8->setTitle(QApplication::translate("EyeTrackingSuiteClass", "Auto Size", nullptr));
        label_9->setText(QApplication::translate("EyeTrackingSuiteClass", "Viewing Distance (in):", nullptr));
        label_10->setText(QApplication::translate("EyeTrackingSuiteClass", "Size in Degrees:", nullptr));
        scotomaAutoSize->setText(QApplication::translate("EyeTrackingSuiteClass", "Auto Resize Scotoma", nullptr));
